...
public class MailUtility {
    ...
    public boolean sendEmail(String emailType, User user) {
        boolean test = false;
        ...
        if (emailType.equalsIgnoreCase("verify")) {
            requestAction = "verify";
            mailSubject = "Account Verification System";
            
        } else if (emailType.equalsIgnoreCase("resetpassword")) {
            requestAction = "reset password";
            mailSubject = "Reset New Password";
        }
