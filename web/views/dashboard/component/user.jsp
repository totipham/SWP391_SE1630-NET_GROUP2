...
<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
    ...
    <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-md-40px border border-3 border-primary"
        ...
        <img alt="Pic" src="${baseURL}/assets/images/${sessionScope.user.avatar}" />
    </div>
    <!--begin::Menu-->
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px"
        ...
        <div class="menu-item px-3">
            <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="symbol symbol-50px symbol-circle me-5">
                    <img alt="Logo" src="${baseURL}/assets/images/${sessionScope.user.avatar}" />
                </div>
                <!--end::Avatar-->
                <!--begin::Username-->
                <div class="d-flex flex-column">
                    <div class="fw-bolder d-flex align-items-center fs-5">${sessionScope.user.name}</div>
                    <a href="#"
                       class="fw-bold text-muted text-hover-primary fs-7">${sessionScope.user.email}</a>
                </div>
                <!--end::Username-->
            </div>
        </div>
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-5">
            <a href="${baseURL}/report" class="menu-link px-5"><span class="menu-text">Reports</span>
