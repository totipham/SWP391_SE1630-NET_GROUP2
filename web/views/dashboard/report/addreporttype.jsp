<%-- 
    Document   : addreporttype
    Created on : Nov 3, 2022, 4:04:58 PM
    Author     : Admin
--%>
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid fs-6" id="kt_content">
                        ...
                        <div class="container-fluid" id="kt_content_container">
                            <form action="addreporttype" method="post">
                                <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group m-3">
                                                    <label class="fw-bold mb-2" for="name">Report Type <span style="color: red">*</span></label>
                                                    <input type="text" class="form-control" name="reporttype" id="reporttype" placeholder="Enter Report Type" required>
                                                </div>
                                            </div>
